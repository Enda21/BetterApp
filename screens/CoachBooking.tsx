...
const coaches: Coach[] = [
  ...
  { name: 'Owen M', calendlyUrl: 'https://calendly.com/oshea-tos/review-and-strategy-call-with-thomas' },
  { name: 'Thomas', calendlyUrl: 'https://calendly.com/oshea-tos/review-and-strategy-call-with-thomas' },
];
